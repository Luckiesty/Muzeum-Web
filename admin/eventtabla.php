        ...
        print(' <div id="table-scroll">
            ...
            <tbody>');
                    ...
                    while($sor = $lekerdezes->fetch_assoc()){
                        ...
                        <td><a data-toggle="modal"  data-target="#modalForm1" id="list" data-id="'.$sor['id'].'"  class="btn btn-success btn-lg" href="#modalForm">
                        szerkesztés</a>
                        <form action="eventtorles.php" method="post" id="tor">
