...
<body>
    ...
    <div class="container">
        <div data-collapse="medium" data-animation="default" data-duration="400" data-easing="ease" data-easing2="ease" role="banner" class="navigation w-nav">
                <div class="navigation-wrap">
                    ...
                    <div class="menu">
                        ...
                        <a href="/../index.php" class="navigation-item w-nav-link">Vissza</a> 	 
                            ...
                            <a href="foglalas.php" class="navigation-item w-nav-link">foglalas</a> 	                                   
                        </nav>
        ...
        <div class="container2" id="tablazat"><?php include('foglalas_tabla.php'); ?> 
...
<div class="modal fade" id="modalForm1" role="dialog">
  ...
  var id = $(this).data("id");
  console.log(id);
$.ajax({url:"foglalas_modal.php?id="+id,cache:false,success:function(result){
        $(".modal1").html(result);
